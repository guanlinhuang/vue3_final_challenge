<template>
  <div class="Smallsidebar d-none d-lg-block  d-flex flex-column align-items-center">
    <div class="followUs mb-2 me-2 position-relative rounded-circle">
      <a href="#" class="text-white d-block position-absolute start-50 translate-middle" style="top:27px"
    ...
    <div class="followUs mb-2 me-2 position-relative rounded-circle">
      <a href="https://line.me/ti/p/OwNL1F9kBd" class="text-white d-block position-absolute start-50 translate-middle" style="top:28px"
