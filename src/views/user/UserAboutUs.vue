<template>
  ...
  <div class="about">
    <div class="container py-5 mainContainer">
      ...
      <div
        class="row row-cols-1 flex-row-reverse justify-content-center mt-3 mt-lg-5"
      >
        <div class="col col-lg-5">
          <div class="about_img_1"></div>
        </div>
        <div class="col col-lg-5 px-5 px-sm-4 mt-2 mt-lg-0">
          <h4 class="pt-3">初期</h4>
      ...
      <div class="row row-cols-1 justify-content-center mt-4">
        ...
        <div class="col col-lg-5 px-5 px-sm-4 mt-2 mt-lg-0 pb-5 pb-lg-0">
          <h4 class="pt-3">現今</h4>
          <p class="lh-lg" style="text-align: justify">
            &emsp;&emsp;隨著時代的快速變遷以及飲品市場競爭的激烈，創辦人決定於2007年起開設分店，讓顧客能在更舒適的環境中享受飲品，同時，創辦人重新思考品牌的發展方向，並順應市場潮流，將咖啡與健康果汁結合，為消費者提供更多元的選擇。這樣的創新不僅滿足了希望飲用健康飲品的顧客，也吸引了追求時尚飲品的消費者，意外地收獲了來自各界的好評。
            如今，GuanTony
            在全台六個城市開設了分店，讓每一位顧客都能在GuanTony品嚐到既健康又時尚的飲品，體驗到品牌始終堅持的初心與創新精神。
          </p>
        </div>
      </div>
    </div>
